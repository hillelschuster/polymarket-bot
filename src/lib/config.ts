...
const envSchema = z.object({
  ...
  LIVE_MAX_TOTAL_EXPOSURE_USD: z.coerce.number().positive().default(150),
  LIVE_MAX_OPEN_POSITIONS: z.coerce.number().int().positive().default(15),
  LIVE_MAX_POSITION_USD: z.coerce.number().positive().default(10),
